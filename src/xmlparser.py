...
if __name__ == '__main__':
    prepro_file('./processed_data/risamalromur/total_shuffled.txt', './processed_data/risamalromur/clean_total.txt')
    #parse('/data/risamalheild/rmh1/MIM/visindavefur', './processed_data/risamalromur/visindavefur.txt')